...
var _imgService = require("./js/img-service");
var _imgServiceDefault = parcelHelpers.interopDefault(_imgService);
...
let query = "";
const imgService = new (0, _imgServiceDefault.default)();
...
let gallery = new (0, _simplelightboxDefault.default)(".photo-card a", {
    showCounter: false,
    enableKeyboard: true
});
...
function onSearch(e) {
    ...
    if (!value) {
        (0, _notiflix.Notify).failure("There is nothing to find", {
            clickToClose: true
        });
        return;
    }
    ...
    fetchAndRender().then((result)=>{
        if (result) (0, _notiflix.Notify).success(`Hooray! We found ${result} images.`, {
            clickToClose: true,
            timeout: 2000
        });
        form.reset();
...
function renderGallery(hits) {
    const card = hits.map(({ webformatURL , largeImageURL , tags , likes , views , comments , downloads ,  })=>`<div class="photo-card">
...
},{"./sass/main.scss":"dFl68","notiflix":"5WWYd","./js/img-service":"i7cfK","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dFl68":[function() {},{}],"5WWYd":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"i7cfK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
